          ...
          <ul class="cart-item-list">
            ...
            >
              ...
              <div class="item-total">
                {{ productTotalPrice(item, index) }}元
              </div>
...
export default {
  ...
  methods: {
    ...
    check (index) {
      this.list[index].productSelected = !this.list[index].productSelected
    },
    productTotalPrice (item, index) {
      return this.list[index].productTotalPrice = item.productPrice * item.quantity
    },
    async getCartList () {
    ...
    async updateCart (item, type) {
      ...
      const res = await this.axios.put('/carts/' + item.productId, {
        quantity,
        selected
      })
      this.renderData(res)
    ...
    async delProduct (item) {
      const res = await this.axios.delete(`/carts/${item.productId}`)
      this.renderData(res)
    },
    async toggleAll () {
